...
//                    .showListener(showListener)
    ...
    public static void showInputDialog(Activity activity, String title, String content, int inputType, int hint, int minLenth, int maxLenth,MaterialDialog.InputCallback callback) {
        if (myDialog == null) {
            myDialog = new MaterialDialog.Builder(activity)
                    .title(title)
                    .content(content)
