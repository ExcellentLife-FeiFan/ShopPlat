...
public class UserM implements Serializable {
     ...
     * Lng : 116.519653
     * Lat : 39.896282
     * AddressContent : 北京市朝阳区方家村
     * QSPrice : 30.00
     * PSPrice : 5.00
     * Confines : 5000
     * PSWhenLong :
     * KeyWord :
     * LogoUrl : /File/UpFiles/s(1).jpg
     * Notice : 本超市商品一律五折大甩卖
     * Contacts : 徐东东
     * Phone : 15212312345
     * HJUrl :
    ...
    public String getPSWhenLong() {
        return PSWhenLong;
    }

    public void setPSWhenLong(String PSWhenLong) {
    ...
    public void setManJian(Object ManJian) {
