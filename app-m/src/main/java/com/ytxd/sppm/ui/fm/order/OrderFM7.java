...
public class OrderFM7 extends BaseFragment<OrderFMPresenter> implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener, IOrderFMView {
    @BindView(R.id.rv)
    RecyclerView rv;
    @BindView(R.id.msv)
    MultiStateView msv;
...
//                startActivity(MerchantDetailActivity.class, "data", mAdapter.getItem(i));
        ...
        presenter.getOrderList(CommonUtils.REFRESH, page, OrderM.HAVE_REFUND);
    }
    ...
    public void onRefresh() {
        presenter.getOrderList(CommonUtils.REFRESH, 1, OrderM.HAVE_REFUND);
    }

    @Override
    public void onLoadMoreRequested() {
        presenter.getOrderList(CommonUtils.LODEMORE, ++page, OrderM.HAVE_REFUND);
    }
