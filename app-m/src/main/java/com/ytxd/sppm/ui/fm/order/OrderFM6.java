...
//                startActivity(MerchantDetailActivity.class, "data", mAdapter.getItem(i));
        ...
        presenter.getOrderList(CommonUtils.REFRESH, page, OrderM.CANCEL);
    }
    ...
    public void onRefresh() {
        presenter.getOrderList(CommonUtils.REFRESH, 1, OrderM.CANCEL);
    }

    @Override
    public void onLoadMoreRequested() {
        presenter.getOrderList(CommonUtils.LODEMORE, ++page, OrderM.CANCEL);
    }
